...
/**
 * This class contains JUnit tests for a String type of BinaryMaxHeap.java with a custom comparator.
 *
 * @author Nandini Goel and Kira Halls
 * @version Nov 27, 2022
 */
class BinaryMaxHeapStrCmpTester {
    ...
    private BinaryMaxHeap<String> strMaxHeap = new BinaryMaxHeap<>(stringCmp);
    private BinaryMaxHeap<String> emptyMaxHeap = new BinaryMaxHeap<>(stringCmp);
    ...
    @BeforeEach
    void setUp() {
        emptyMaxHeapList = new BinaryMaxHeap<>(list, stringCmp);
        for (int i = 0; i < 26; i++) {
            String letter = (char)('A' + i % 26) + "";
            strMaxHeap.add(letter);
            list.add(letter);
        }
        strMaxHeapList = new BinaryMaxHeap<>(list, stringCmp);
    }
