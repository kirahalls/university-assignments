...
/**
 * This is the test class for the StudentMediumHash class
 * 
 * @author Kira Halls and Nandini Goel
 *
 */
class StudentMediumHashTest {
	StudentMediumHash alan, ada, edsger, grace;
	HashTable<StudentMediumHash, Double> studentGpaTable;

	@BeforeEach
	void setUp() {
		alan = new StudentMediumHash(1019999, "Alan", "Turing");
		ada = new StudentMediumHash(1004203, "Ada", "Lovelace");
		edsger = new StudentMediumHash(1010661, "Edsger", "Dijkstra");
		grace = new StudentMediumHash(1019941, "Grace", "Hopper");
	...
	@Test
	void testHashOutput() {
		assertEquals(10, alan.hashCode());
		assertEquals(11, ada.hashCode());
		assertEquals(14, edsger.hashCode());
		assertEquals(11, grace.hashCode());
	}
